...
!developmentChains.includes(network.name)
    ...
    : describe("Nft Marketplace Unit Tests", function () {
          ...
          describe("withdrawProceeds", function () {
              ...
              //   it("errors if transfer failed", async function () {
              //       // Get the initial proceeds of the seller
              //       const initialProceeds = await nftMarketplace.getProceeds(deployer.address)

              //       // Attempt to withdraw the proceeds to an invalid address
              //       await expect(
              //           nftMarketplace.withdrawProceeds({ from: deployer.address })
              //       ).to.be.revertedWith("NftMarketplace__TransferFailed")

              //       // Ensure that the proceeds remain unchanged
              //       const finalProceeds = await nftMarketplace.getProceeds(deployer.address)
              //       expect(finalProceeds).to.be.equal(initialProceeds)
              //   })
          })
      })
